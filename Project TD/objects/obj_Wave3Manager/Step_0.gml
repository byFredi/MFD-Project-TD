...
if(obj_WaveManager.currentEnemy == 1){	/// @DnDAction : YoYo Games.Instances.If_Instance_Exists
	...
	var l6DA4D1FC_0 = false;l6DA4D1FC_0 = instance_exists(obj_w3_e1);if(!l6DA4D1FC_0){	/// @DnDAction : YoYo Games.Common.If_Expression
		/// @DnDVersion : 1
		/// @DnDHash : 3EA99707
		/// @DnDParent : 6DA4D1FC
...
if(obj_WaveManager.currentEnemy == 2){	/// @DnDAction : YoYo Games.Instances.If_Instance_Exists
	...
	var l5BEBDB4A_0 = false;l5BEBDB4A_0 = instance_exists(obj_w3_e2);if(!l5BEBDB4A_0){	/// @DnDAction : YoYo Games.Common.If_Expression
		/// @DnDVersion : 1
		/// @DnDHash : 59B1B33E
		/// @DnDParent : 5BEBDB4A
...
if(obj_WaveManager.currentEnemy == 3){	/// @DnDAction : YoYo Games.Instances.If_Instance_Exists
	...
	var l07D32222_0 = false;l07D32222_0 = instance_exists(obj_w3_e3);if(!l07D32222_0){	/// @DnDAction : YoYo Games.Common.If_Expression
		/// @DnDVersion : 1
		/// @DnDHash : 29559960
		/// @DnDParent : 07D32222
...
if(obj_WaveManager.currentEnemy == 4){	/// @DnDAction : YoYo Games.Instances.If_Instance_Exists
	...
	var l0FB78A73_0 = false;l0FB78A73_0 = instance_exists(obj_w3_e4);if(!l0FB78A73_0){	/// @DnDAction : YoYo Games.Common.If_Expression
		/// @DnDVersion : 1
		/// @DnDHash : 3B665C97
		/// @DnDParent : 0FB78A73
...
if(obj_WaveManager.currentEnemy == 5){	/// @DnDAction : YoYo Games.Instances.If_Instance_Exists
	...
	var l1816197D_0 = false;l1816197D_0 = instance_exists(obj_w3_e5);if(!l1816197D_0){	/// @DnDAction : YoYo Games.Common.If_Expression
		/// @DnDVersion : 1
		/// @DnDHash : 7D65C86E
		/// @DnDParent : 1816197D
